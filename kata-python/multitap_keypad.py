...
# Punctuation can be ignored for this exercise. Likewise, you can assume the phone doesn't 
# distinguish between upper/lowercase characters (but you should allow your module to accept input in either for
# convenience).
